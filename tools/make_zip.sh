...
for extra in docs/PROCESS.md Dockerfile .dockerignore docs/ARCHITECTURE.md docs/JURY.md docs/MASKS.md docs/QUALITY.md docs/LOAD.md docs/LIMITATIONS.md docs/DEMO.md; do
...
# How the specs were prepared is disclosed only in README.md and docs/PROCESS.md.
disclosure='^\./DetoxProxy/(README\.md|docs/PROCESS\.md):'
...
echo "scan clean: mentions only in README.md and docs/PROCESS.md"
