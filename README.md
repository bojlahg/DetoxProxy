...
Весь код продукта написан coding-агентом DeepSeek-V4-Flash-0731 через AlfaGen (OpenCode, настройки — `opencode.json`). ТЗ для агента команда готовила с помощью ассистента Claude; как устроен процесс — `docs/PROCESS.md`.
